...
const TrabajadorSchedule = () => {
    ...
    // Utility function to manage time conversions
    ...
    useEffect(() => {
        ...
        setHourLimits(prevHourLimits => {
            ...
            extraHours.forEach(eh => {
                if (organizedHours[eh.day_type]) {
                    organizedHours[eh.day_type].push(eh);
                } else {
                    organizedHours[eh.day_type] = [eh];
                }
            });
            ...
            Object.keys(organizedHours).forEach(dayTypeKey => {
                ...
                // Ensure dayType entry in newHourLimits
                if (!newHourLimits[dayType]) {
                    newHourLimits[dayType] = {
                        minEntryHour: '5:00',
                        maxEntryHour: '5:00',
                        minExitHour: '20:30',
                        maxExitHour: '20:30'
